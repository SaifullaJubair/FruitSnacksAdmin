...
const HomeLayoutTab = ({ refetch, getInitialCurrencyData }) => {
  ...
  // Topbar card intentionally removed: topbar_show/topbar_announcement_text/
  // topbar_show_track_order/topbar_show_hotline still save to the settings
  // doc, but nothing on the storefront reads them (grep: 0 hits each) — the
  // only component that did, TopNavbar, is commented out of (frontend)/layout.js.
  // The bar that actually renders in that slot is <AnnouncementBar>, driven
  // by `announcement_bar` — edit it on the Announcement Bar tab instead.
