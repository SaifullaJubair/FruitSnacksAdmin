  ...
  useEffect(() => {
    if (!stepTwoData.dont_need_maping) {
      const transformed = stepTwoData?.map((spec) => ({
        ...
        attribute_name: spec?.specification_id?.attribute_name,
        ...
        attribute_slug: spec?.specification_id?.attribute_slug,
        attribute_status: spec?.specification_id?.attribute_status,
        _id: spec?.specification_id?._id,
        attribute_values: spec?.specification_values?.map((value) => ({
          attribute_value_name:
            value?.specification_value_details?.attribute_value_name,
          attribute_value_slug:
            value?.specification_value_details?.attribute_value_slug,
          attribute_value_status:
            value?.specification_value_details?.attribute_value_status,
