  ...
  <Fragment>
    ...
    <table>
      <tbody>
        <tr>
          <th>Meta title</th>
          <td>Premium Dried Mango 250g | 100% Natural | FruitSnacksBD</td>
        </tr>
        <tr>
          <th>Meta description</th>
          <td>Naturally sweet sun-dried Bangladeshi mango chunks. No preservatives, BSTI approved. Free delivery in Dhaka — order now।</td>
        </tr>
        <tr>
          <th>Meta keywords</th>
          <td>dried mango, dried fruits bd, healthy snacks bangladesh, natural snacks dhaka</td>
        </tr>
      </tbody>
    </table>
