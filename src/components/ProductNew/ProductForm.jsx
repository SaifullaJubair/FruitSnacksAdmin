...
const ProductForm = ({ mode = "add", initialData = null, onSaved }) => {
  ...
  const validateVariationRows = () => {
    for (let i = 0; i < inputValueData.length; i++) {
      ...
      // no price at all skipped every check and saved as 0. That is how four live
      // products ended up showing a bare "0" beside the price, a ৳0 subtotal, and
      // vanishing from the storefront's price filter. Every row needs a price.
