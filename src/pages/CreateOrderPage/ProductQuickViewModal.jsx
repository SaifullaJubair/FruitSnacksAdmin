          ...
          <div className="flex-1 p-4 space-y-3">
            ...
            {(selectedVar?.variation_sku || product.product_sku) && (
              <p className="text-xs text-gray-400">
                SKU: {selectedVar?.variation_sku || product.product_sku}
              </p>
            )}
                  ...
                  {product.variations.map((v) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {outOfStock && (
                          <span className="absolute -top-1.5 -right-1.5 bg-red-500 text-white text-[8px] px-1 rounded-full">
                            0
                          </span>
                        )}
                      </button>
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                ...
                <span className="px-4 py-1.5 text-sm font-bold text-gray-800 border-x border-gray-300 min-w-[40px] text-center">
                  {qty}
                </span>
