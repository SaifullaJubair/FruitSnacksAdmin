...
//
// The list used to be a flat run of 24 modules in the order they were built, so
...
//
// Every flag below is enforced by the backend (`verifyToken("flag")`) except the
// `_show` ones on modules whose GET routes are public (theme, faq_template,
// trust_point) — those gate the sidebar entry only, which is the intent.
const permissionsData = [
  ...
  // tick "User Show" alone and the API worked while the menu stayed hidden. The
